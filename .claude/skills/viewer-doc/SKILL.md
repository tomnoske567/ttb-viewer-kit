---
name: viewer-doc
description: Build or update the user's Ideal Viewer Document — a living profile of exactly who their content is for, built from their real data (transcripts, call recordings, comments, DMs) plus a guided interview. Triggers on "/viewer-doc", "build my viewer doc", "create my ideal viewer document", "who is my viewer", "build my ICP", "update my viewer doc", or when the user opens this kit and asks where to start.
---
